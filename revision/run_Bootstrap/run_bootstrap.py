...
# resolves ANALYSIS_DIR from its own location, so the per-section outputs below
# keep landing under bayesian_vs_fold_change/results/ regardless of where this
