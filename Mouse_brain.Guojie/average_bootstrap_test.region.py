...
# starrfish3_sec1 = STARRFISH(adata3_sec1, celltype_tag='obs:region')
# starrfish3_sec2 = STARRFISH(adata3_sec2, celltype_tag='obs:region')
# starrfish3 = STARRFISH(adata3, celltype_tag='obs:region')
# del adata3_sec1, adata3_sec2, adata3
starrfish3_sec1 = STARRFISH.load('results/starrfish3_sec1.bak.region.pkl')
starrfish3_sec2 = STARRFISH.load('results/starrfish3_sec2.bak.region.pkl')
starrfish3 = STARRFISH.load('results/starrfish3.bak.region.pkl')
...
# starrfish3_sec1.save('results/starrfish3_sec1.bak.region.pkl')
# del starrfish3_sec1

res2 = starrfish3_sec2.average_bootstrap_test(**average_bootstrap_test_config)
# starrfish3_sec2.save('results/starrfish3_sec2.bak.region.pkl')
# del starrfish3_sec2

res = starrfish3.average_bootstrap_test(**average_bootstrap_test_config)
# starrfish3.save('results/starrfish3.bak.region.pkl')
# del starrfish3
...
ax.set_xscale('log')
fig.savefig('results/expr3/region/reproducibility_by_celltype_pearson_sec1_sec2.pdf')
fig, ax = plt.subplots(figsize=(4, 4))
...
fig.savefig('results/expr3/region/reproducibility_by_celltype_pearson_violin_sec1_sec2.pdf')
...
fig.savefig('results/expr3/region/reproducibility_by_celltype_sec1_sec2.pdf')
# Plot sec1-all
fig = plot_reproducibility(overlap_df, reproducible_celltypes, 'percentage_sec1_all', 'sec1', 'all', 'sec1', 'all')
fig.savefig('results/expr3/region/reproducibility_by_celltype_sec1_all.pdf')

# Plot sec2-all
fig = plot_reproducibility(overlap_df, reproducible_celltypes, 'percentage_sec2_all', 'sec2', 'all', 'sec2', 'all')
fig.savefig('results/expr3/region/reproducibility_by_celltype_sec2_all.pdf')
...
fig.tight_layout()
fig.savefig('results/expr3/region/reproducibility_comparison_barplot.pdf')
fig.show()
...
for celltype in reproducible_celltypes:
    ...
    if len(cre_right) > 0:
        ...
        fig.savefig(f'results/expr3/region/celltype_significant_cres/{celltype}_{cre}_right_tail.pdf')
    if len(cre_left) > 0:
        cre = cre_left[0]
        ...
        fig = starrfish3.plot_gene(
            ...
            transpose=-1, flipx=-1, sz_max=50,
            cell_types_to_use=cell_types_to_visualize)
        fig.savefig(f'results/expr3/region/celltype_significant_cres/{celltype}_{cre}_left_tail.pdf')
...
subclass_to_class = allen_cell_type_nomination[['subclass_label', 'neighborhood']].set_index('subclass_label')['neighborhood']
...
for use in ['atac-peak', 'h3k27ac-peak', 'h3k4me1-peak', 'chromatin-a']:
    ...
    fig.savefig(f'results/expr3/region/{use.replace("-", "_")}_precision_by_celltype.pdf')
...
fig.savefig('results/expr3/region/overall_precision_barplot.pdf')
fig.show()
...
for use in ['atac-peak', 'h3k27ac-peak', 'h3k4me1-peak', 'chromatin-a']:
    for y in ['precision', 'percentage']:
        ...
        plt.tight_layout()
        fig.savefig(f'results/expr3/region/cre_{y}_barplot_{use.replace("-", "_")}.pdf')
        plt.show()
...
upset.plot(fig=fig)
fig.savefig('results/expr3/region/cre_ontarget_upsetplot.pdf')
# %%
