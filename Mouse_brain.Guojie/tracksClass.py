...
from pygenometracks.utilities import file_to_intervaltree, change_chrom_names, MyBasePairFormatter, get_region
...
class PlotTracks(object):
    ...
    def plot(self, file_name, chrom, start, end, title=None, highlight_region=None,
        ...
        # After the main track plotting loop, add this code:
        if highlight_region is not None:
            h_start, h_end = highlight_region
            for ax in axis_list:
                # Add semi-transparent rectangle across all tracks
                ax.axvspan(
                    h_start,
                    h_end,
                    color='grey',
