...
# %%
infection_rate_df, mu_df, disp_df = starrfish3_sec2.poisson_neg_binom_mle_separate(None, None)
# %%
infection_rate_df.to_csv('results/expr3/poisson_neg_binom_mle_separate.infection.rate.sec2.csv')
mu_df.to_csv('results/expr3/poisson_neg_binom_mle_separate.mu.sec2.csv')
disp_df.to_csv('results/expr3/poisson_neg_binom_mle_separate.disp.sec2.csv')
# %%