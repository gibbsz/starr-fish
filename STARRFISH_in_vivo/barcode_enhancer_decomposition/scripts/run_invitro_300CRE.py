...
_INVITRO_ROOT = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                              "..", "..", "..", "STARRFISH_in_vitro")
ACTIVITY_CSV = os.path.join(_INVITRO_ROOT, "results", "activity_matrix_300CRE.csv")
LIBRARY_FILTER = "285CRE/in vitro" # Filter for sequences (matches SEQUENCES_XLSX)
SAVE_DIR = os.path.join(RESULTS_DIR, "invitro_300CRE")
...
def main():
    parser = argparse.ArgumentParser(description="300CRE/in vitro decomposition")
