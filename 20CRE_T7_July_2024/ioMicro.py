...
def get_fov_tag_set(fl):
    ...
    return fov,tag,set_
def get_drift_edge(iseg,icompfov,pos_pix=None,resc=None,segm_fls=None,save_folder = r'\\192.168.0.96\bbfish124\HttHuman_Snonia__08_03_2023\MERFISH_Analysis_group1',pd=50,plt_val=False):
    """
