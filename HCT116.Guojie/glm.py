...
def plot_glm_results(glm_result, x_col='Poshen Activity', y_col='STARR-FISH Activity', fig_name='glm_result.pdf', ax=None):
    ...
    slope, intercept, r, p, sterr = scipy.stats.linregress(x=glm_result[y_col], 
                                                           y=glm_result[x_col])
...
def plot_corr_experiments(experiment1, experiment2, value='STARR-FISH Activity', std='STARR-FISH Activity std err', 
    ...
    glm_res1 = experiment1.dropna().copy()
    glm_res2 = experiment2.dropna().copy()
...
july_experiment = preprocess_experiment('data/SFv4_T7_July_enhancer_cbg.csv', 'data/SFv4_T7_July_T7_cbg.csv', 
                                        'data/Bulk_sequencing/RNA_sequencing/CRE20_T7_July_featureCounts_output.txt',
                                        'data/Bulk_sequencing/DNA_sequencing/CRE20_July_featureCounts_output.txt')
sept_experiment = preprocess_experiment('data/SFv4_T7_Sept_enhancer_cbg.csv', 'data/SFv4_T7_Sept_T7_cbg.csv',
                                        'data/Bulk_sequencing/RNA_sequencing/CRE20_T7_Sept_featureCounts_output.txt',
                                        'data/Bulk_sequencing/DNA_sequencing/CRE20_Sept_featureCounts_output.txt')
# fit glm
...
def plot_glm_two_experiments(exp1, exp2, key='glm_fit_result'):
    ...
    plot_glm_results(exp1[key], x_col='Poshen Activity', fig_name=None, ax=ax[0, 0])
    plot_glm_results(exp1[key], x_col='Poshen Activity DESeq2', fig_name=None, ax=ax[0, 1])
    plot_glm_results(exp1[key], x_col='RNA/DNA', fig_name=None, ax=ax[0, 2])
    plot_glm_results(exp1[key], x_col='RNA/DNA lfc', fig_name=None, ax=ax[0, 3])
    plot_glm_results(exp2[key], x_col='Poshen Activity', fig_name=None, ax=ax[1, 0])
    plot_glm_results(exp2[key], x_col='Poshen Activity DESeq2', fig_name=None, ax=ax[1, 1])
    plot_glm_results(exp2[key], x_col='RNA/DNA', fig_name=None, ax=ax[1, 2])
    plot_glm_results(exp2[key], x_col='RNA/DNA lfc', fig_name=None, ax=ax[1, 3])
    return fig
# %%
...
plot_corr_experiments(july_experiment['glm_fit_total_result_T7'], july_experiment['glm_fit_total_result_nanopore'], fig_name=None, ax=ax[0],
                      x_label='July (Enhancer~total) / nanorepore', y_label='July (Enhancer~total) / (T7~total)')
plot_corr_experiments(sept_experiment['glm_fit_total_result_T7'], sept_experiment['glm_fit_total_result_nanopore'], fig_name=None, ax=ax[1],
